...
def main(args):
    ...
    if args.gdim == 2:
        ...
        svmtk_create_slice_mesh(stlfile=stl, output=MSHMESH, plane=PLANE, resolution=args.resolution)

    else:
        print("Mesh will be 3-dimensional.")
        # call the appropriate SVMTK meshing function.
        svmtk_create_volume_mesh(stlfile=stl, output=MSHMESH, resolution=args.resolution)
